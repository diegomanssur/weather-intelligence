...
from weather_client import weather_bp
...
# weather_client.py's Blueprint owns its own routing (POST /weather/sync) and
# table setup (ensure_table() for weather_documents), same way the /news/sync
# route below owns ticker_news_documents - see weather_client.py for the NWS
# fetch/normalize/upsert logic.
